...
function App() {
  ...
  // Data for chart and top expenses
    ...
    <div className="app-container">
      ...
      <div className="top-row-grid">
        <div className="card balance-card">
          ...
          <button className="btn add-income-btn" onClick={openIncomeModal}>
            + Add Income
          </button>
        </div>
        ...
        <div className="card expenses-card">
          <h3 className="card-title">
            Expenses: <span className="expense-amount">₹{expenseTotal}</span>
          </h3>
          <button className="btn add-expense-btn" onClick={openExpenseModal}>
            + Add Expense
          </button>
        </div>
                ...
                <li key={tx.id} className={`transaction-item ${tx.type}`}>
                  <div className="tx-details">
                    <span className="tx-title">
                      {tx.title} {tx.type === "expense" && `(${tx.category})`}
                    </span>
              ...
              <li key={data.name}>
                ...
                <div className="progress-bar-container">
                  <div
                    ...
                    style={{
                      width: `${
                        expenseTotal > 0 ? (data.value / expenseTotal) * 100 : 0
                      }%`,
        ...
        <div className="modal-overlay">
          <div className="modal-content income-modal">
            ...
            <div className="modal-form-row">
              <input
                type="number"
                name="balance" // <--- updated for test compatibility
            ...
            <div className="modal-actions">
              <button
                className="btn modal-add-btn primary"
                onClick={addIncome}
                type="button" // <--- avoid submit/reload
              >
                Add Balance
              </button>
              <button className="btn modal-cancel-btn" onClick={closeIncomeModal}>
                Cancel
              </button>
            </div>
          </div>
      ...
      {isExpenseModalOpen && (
        <div className="modal-overlay">
          <div className="modal-content expense-modal">
            ...
            <div className="modal-actions">
              <button
                className="btn modal-add-btn expense-primary"
                onClick={addExpense}
              >
                Add Expense
              </button>
              <button className="btn modal-cancel-btn" onClick={closeExpenseModal}>
                Cancel
              </button>
            </div>
          </div>
